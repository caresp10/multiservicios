...
function renderFacturas(data) {
    ...
    table.innerHTML = data.map(factura => `
        <tr>
            ...
            <td>
                <button class="btn btn-sm btn-outline-info" data-id="${factura.idFactura}" title="Ver factura" onclick="window.verFacturaPorId(${factura.idFactura})">
                    <i class="fas fa-eye"></i>
                </button>
                <button class="btn btn-sm btn-outline-success" title="Exportar PDF" onclick="window.exportarFacturaPDF(${factura.idFactura})">
                    <i class="fas fa-file-pdf"></i>
                </button>
                <button class="btn btn-sm btn-outline-warning" title="Editar" onclick="window.editarFactura(${factura.idFactura})">
